...
filename='/home/zach/Downloads/enwiktionary-latest-pages-articles.xml'
output='./fr_en_dict.csv'
start = 5

meaning_start = set(['==Adjective==', '==Noun==', '==Preposition==', '==Verb==', '==Adverb=='])
translate_start = set(['==Translations=='])

common_end = '=='
desc_start = '# '
desc_start2 = '## '
language_start = ['* English:']
