...
def main():
    ...
    for event, elem in doc:
        ...
        if "page" in elem.tag:
            ...
            if title.startswith("Wiktionary:") or title.startswith("Conjugaison:") or title.startswith("Category:") or title.startswith("Help:"):
            ...
            try:
                for section in parse(content).sections:
                    ...
                    if templates:
                        ...
                        if template_arguments[0].value != "en":
                            continue
                    ...
                    #        continue
                        ...
                        if (
                            ...
                            and not any( part in PARTS_OF_SPEECH for part in template_arguments[1].value.lower().split() )
                        ):
                            continue
                    ...
                    #        continue
                        ...
                        print(title,template_arguments[1].value,part_of_speech)
            ...
            #               print([y for x in section.lists()[0].get_lists("#") for y in x.items])
                    ...
                    #     print("###")
                        ...
                        #TODO:remove list
                        meanings=filter(lambda x: x not in ('','.','…','….') and not re.match("^\([^\(]*\)\.?$", x) and not re.match(r"^\([^)]*\)[. ]*$",x),meanings)
